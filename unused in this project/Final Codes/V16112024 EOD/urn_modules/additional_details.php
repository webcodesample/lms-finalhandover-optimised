...
<span class="px-2 fs-9 mt-1">Has the applicant applied for any type of immigration into any country?</span>
<?php
...
<textarea class="form-control form-control-sm m-1 mt-3 <?=setBtnVisibilityClass($urn_using_by_me)?>" name="updation_remark" placeholder="Additional Details Updation Remark" required style="width:410px;height:100px;"></textarea>

<div class="text-center mt-3" style="width:400px;">
<button type="submit" class="btn btn-sm btn-primary m-1 <?=setBtnVisibilityClass($urn_using_by_me)?>" <?=$field_visibility?>>Update Additional Details</button>
</div>
<?php } ?>
</form>
