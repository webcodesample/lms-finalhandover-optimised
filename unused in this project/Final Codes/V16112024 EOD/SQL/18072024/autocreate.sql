...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 18, 2024 at 11:42 AM
...
INSERT INTO `menu_items` (`id`, `description`, `submenu_id_name`, `icon_name`) VALUES
(1, 'CRM', 'CRM', 'pie-chart'),
(2, 'URN Management', 'URN', 'users'),
(3, 'University Management', 'UNIV', 'clipboard'),
(4, 'User Management', 'USER', 'user'),
(5, 'Report Management', 'REPORT', 'file'),
(6, 'Chat', 'CHAT', 'message-square'),
(8, 'Site Management', 'SITE', 'dribbble'),
(7, 'Management Account', 'FUND', 'dollar-sign'),
(9, 'Menu Management', 'MENU', 'align-left');
...
(2, 'Yogesh Bafna', 'yogesh@bafna.net', 9902012547, 'Director', 'Management', 1, '1,2,3,4,5,6,7,8'),
(3, 'Jasintha', 'jasi@bs.com', 1234567890, 'CSE', 'Support', 3, '1,2,6'),
(1, 'admin', 'info@campus-abroad.co.in', 9902012547, 'Admin', 'Management', 7, '1,2,3,4,5,6,7,8,9'),
(8, 'Manish Bafna', 'manish@bafna.net', 123456, 'Manager', 'Management', 8, '1,2,3,4,5,6'),
...
(3, 'Rajiv', 12345, '', 1720429137, 2, 1, 1, 0, '', 0),
(4, 'Rakesh', 12345, '', 1720429137, 2, 1, 2, 2, 'Fake Data', 1),
(30, 'Jasi', 123456, 'jasi@bs.com', 1721286783, 2, 1, 5, 0, '', 0),
(6, 'Jasi', 12345, 'jasi@test', 1720429137, 2, 1, 3, 0, '', 0),
(7, 'Rita', 12345, 'rita@test', 1720429137, 2, 1, 3, 0, '', 0),
(8, 'Yogesh', 12345, 'yogesh@test', 1720429137, 2, 1, 2, 0, '', 0),
(9, 'Mamta', 12345, 'mamta@test', 1720429137, 2, 1, 1, 0, '', 0),
(10, 'Thomas', 12345, 'thomas@test', 1720429137, 2, 1, 4, 0, '', 0),
(11, 'Shubh', 12345, 'shubh@test', 1720429137, 2, 1, 4, 0, '', 0),
(12, 'Suhana', 12345, 'suhana@test', 1720429137, 2, 1, 1, 0, '', 0),
(13, 'Sonakshi', 12345, 'sonakshi@test', 1720429137, 2, 1, 2, 0, '', 0),
(14, 'Ranveer', 12345, 'ranveer@test', 1720429137, 2, 1, 2, 0, '', 0),
(15, 'Sudha', 12345, 'sudha@test', 1720429137, 2, 1, 2, 0, '', 0),
(16, 'Smita', 12345, 'smita@test', 1720429137, 2, 1, 1, 0, '', 0),
(17, 'James', 12345, 'james@test', 1720429137, 2, 1, 3, 0, '', 0),
(18, 'Poonam', 12345, 'poonam@test', 1720429137, 2, 1, 3, 0, '', 0),
(19, 'Savita', 12345, 'savita@test', 1720429137, 2, 1, 2, 0, '', 0),
(20, 'Mahesh', 12345, 'mahesh@test', 1720429137, 2, 1, 1, 0, '', 0),
(21, 'Ahmad', 12345, 'ahmad@test', 1720429137, 2, 1, 2, 0, '', 0),
(22, 'Taiyab', 12345, 'taiyab@test', 1720429137, 2, 1, 2, 0, '', 0),
(23, 'Imran', 12345, 'imran@test', 1720429137, 2, 1, 2, 0, '', 0),
(24, 'Jasmin', 12345, 'jasmin@test', 1720429137, 2, 1, 1, 1, 'URN Created', 1),
(25, 'Golu', 12345, '', 1720429137, 2, 1, 1, 0, '', 0),
(26, 'Ritika', 12345, '', 1720429137, 2, 1, 1, 0, '', 0),
(27, 'Manish', 12345, '', 1720429137, 2, 1, 1, 0, '', 0),
(28, 'Navin', 12345, '', 1720429137, 2, 1, 1, 0, '', 0),
(29, 'Uday', 12345, 'uday@test', 1720429137, 2, 1, 2, 0, '', 0),
(31, 'Jasi', 123, 'jasi@bs.coma', 1721293770, 2, 1, 2, 0, '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `testing_report_history`
--

DROP TABLE IF EXISTS `testing_report_history`;
CREATE TABLE IF NOT EXISTS `testing_report_history` (
  `id` int NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `testing_report_list`
--

DROP TABLE IF EXISTS `testing_report_list`;
CREATE TABLE IF NOT EXISTS `testing_report_list` (
  `id` int NOT NULL AUTO_INCREMENT,
