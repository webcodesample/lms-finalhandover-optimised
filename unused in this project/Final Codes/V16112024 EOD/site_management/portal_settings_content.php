...
<div class="d-flex">
	<ul class="nav nav-underline fs-9" id="myTab" role="tablist">
		...
		<li class="nav-item"><a href="portal_settings.php?tab=lead_sources" class="nav-link <?=$lead_sources_active?>">Lead Sources</a></li>
		...
		<li class="nav-item"><a href="portal_settings.php?tab=predefined_actions" class="nav-link <?=$predefined_actions_active?>">Predefined Actions List</a></li>
	</ul>
</div>
<?php
