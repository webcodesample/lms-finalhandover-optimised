  ...
  <div class="modal-dialog modal-dialog-centered">
    ...
    <center>
        ...
        <table class="table table-sm table-borderless w-auto">
            <tr>
                <td align="center">
                    <input type="number" name="amount" id="request_withdrawl_amount" min="1" max="<?=$withdrwable_balance?>" class="form-control form-control-sm" placeholder="Enter Amount" required>
                </td>
            </tr>
            <tr>
                <td align="center">
                    <input type="button" class="btn btn-sm btn-danger rounded" data-bs-dismiss="modal" value="Cancel">
                    <input type="submit" class="btn btn-sm btn-primary rounded" value="Submit" onClick="return freezWithdrawal();" data-bs-dismiss="modal">
                </td>
            </tr>
        </table>
        </form>
