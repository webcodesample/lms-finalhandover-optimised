<?php 
	if(validateStaffAccessRight('courses',$con))
	{ 
?>
<div class="d-flex justify-content-between mb-3">
<h5 class="mt-2">Campus Abroad Course List</h5>
<div>
<a href="add_course.php" onClick="return makeConfirm('add new course')"><img src="../portal-icons/add.png" height="25px"></a>
<button class="btn btn-sm btn-subtle-success m-1 p-1" data-bs-toggle="modal" data-bs-target="#importCourse">Import Courses</button>
<a href="../sample_format/courses_sheet_format.xlsx" onClick="return makeConfirm('download sample sheet')" class="btn btn-sm btn-subtle-warning m-1 p-1">Sample Format</a>
</div>
</div>
...
while($course = mysqli_fetch_assoc($view_result_per_page))
{
	...
	echo "<tr>
		...
		<td>".$course['fee']."</td>
		<td nowrap>
		<a href='edit_course.php?course_id=".$course['course_id']."' onclick='return makeConfirm(&quot;edit ".$course['course_name']."&quot;)'><img src='../portal-icons/edit.png' height='20px'></a>&nbsp;
		<a href='delete_course.php?course_id=".$course['course_id']."' onclick='return makeConfirm(&quot;delete ".$course['course_name']."&quot;)'><img src='../portal-icons/delete.png' height='20px'></a>
		</td>
		</tr>";
}
