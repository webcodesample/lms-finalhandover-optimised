...
function toggleAllSections()
{
	...
	toggleSectionwithAll('personal_detail',btnValue);
	toggleSectionwithAll('highest_education_detail',btnValue);
	toggleSectionwithAll('test_taken_detail',btnValue);
	toggleSectionwithAll('course_selection_detail', btnValue);
	toggleSectionwithAll('passport_detail', btnValue);
}
