...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 22, 2025 at 12:40 PM
...
INSERT INTO `lrn_audit_history` (`id`, `lrn`, `product_id`, `required_loan_amount`, `status_id`, `cust_type`, `name`, `company_name`, `dob`, `mobile`, `alt_mobile`, `email`, `permanent_address`, `current_address`, `brief_note`, `guarantor_id`, `updation_remark`, `datentime`, `updated_columns`) VALUES
(4, 884042, 0, 0, 1, 2, 'Arpita Sinha', 'Arpita Traders', 0, 1452369870, 2563149870, 'arpitasinha@st.com', 'hebbala', '', 'No Note', 0, 'Created By Admin', 1745210504, ''),
(5, 884042, 0, 0, 1, 1, 'Arpita Sinha', 'Arpita Traders', 324671400, 1452369871, 2563149870, 'arpitasinha@st.com', 'hebbala', 'sanjay nagar', 'Special Referrence', 0, 'Mobile, DOB, Current Address, Brief Note Updated', 1745231329, 'mobile,dob,cust_type,current_address,brief_note'),
(6, 884042, 0, 0, 1, 1, 'Arpita Sinha', 'Arpita Traders', 324671400, 1452369872, 2563149870, 'arpitasinha@st.com', 'hebbala', 'sanjay nagar', 'Special Referrence', 0, 'Mobile Updated', 1745231509, 'mobile'),
(7, 884042, 0, 0, 1, 1, 'Arpita Sinha', 'Arpita Traders', 324671400, 1452369872, 2563149871, 'arpitasinha@st.com', 'hebbala', 'sanjay nagar', 'Special Referrence', 0, 'Alt Mobile updated', 1745231708, 'alt_mobile'),
(8, 884042, 0, 0, 1, 2, 'Arpita Sinha', 'Arpita Traders', 482437800, 1452369872, 2563149871, 'arpitasinha@st.com', 'Hebbala Bangalore', 'Sanjay Nagar Bangalore', 'Special Referrence', 0, 'DOB, Both Address, Type Updated', 1745233163, 'dob,cust_type,permanent_address,current_address'),
(9, 884042, 0, 0, 1, 2, 'Arpita Sinha', 'Arpita Traders', 482437800, 1452369872, 2563149871, 'arpitasinha@st.com', 'Hebbala Bangalore', 'Sanjay Nagar Bangalore', 'Special Referrence', 6, 'Guarantor Added', 1745237991, 'guarantor_id'),
(10, 884042, 0, 0, 1, 2, 'Arpita Sinha', 'Arpita Traders', 482437800, 1452369872, 2563149871, 'arpitasinha@st.com', 'Hebbala Bangalore', 'Sanjay Nagar Bangalore', 'Special Referrence', 7, 'Guarantor Updated', 1745238492, 'guarantor_id'),
(11, 884042, 1, 100000, 1, 2, 'Arpita Sinha', 'Arpita Traders', 482437800, 1452369872, 2563149871, 'arpitasinha@st.com', 'Hebbala Bangalore', 'Sanjay Nagar Bangalore', 'Special Referrence', 7, 'Loan Details Added', 1745301537, 'product_id,required_loan_amount'),
(12, 884042, 2, 100000, 1, 2, 'Arpita Sinha', 'Arpita Traders', 482437800, 1452369872, 2563149871, 'arpitasinha@st.com', 'Hebbala Bangalore', 'Sanjay Nagar Bangalore', 'Special Referrence', 7, 'Loan Details Updated', 1745301660, 'product_id,required_loan_amount'),
(13, 884042, 2, 200000, 1, 2, 'Arpita Sinha', 'Arpita Traders', 482437800, 1452369872, 2563149871, 'arpitasinha@st.com', 'Hebbala Bangalore', 'Sanjay Nagar Bangalore', 'Special Referrence', 7, 'Loan Details Updated', 1745301957, 'required_loan_amount'),
(14, 884042, 2, 200000, 1, 2, 'Arpita Sinha', 'Arpita Traders', 640204200, 1452369873, 2563149871, 'arpitasinha@st.com', 'Hebbala Bangalore', 'Sanjay Nagar Bangalore', 'Special Referrence By Admin', 7, 'Mobile, DOB,Brief Note Updated', 1745302230, 'mobile,dob,brief_note'),
(15, 884042, 2, 200000, 1, 2, 'Arpita Sinha', 'Arpita Traders', 640204200, 1452369873, 2563149871, 'arpitasinha@st.com', 'Hebbala Bangalore', 'Sanjay Nagar Bangalore', 'Special Referrence By Admin', 6, 'Guarantor Updated', 1745302322, 'guarantor_id'),
(16, 884042, 2, 2000002, 1, 2, 'Arpita Sinha', 'Arpita Traders', 640204200, 1452369873, 2563149871, 'arpitasinha@st.com', 'Hebbala Bangalore', 'Sanjay Nagar Bangalore', 'Special Referrence By Admin', 6, 'Loan Details Updated', 1745303744, 'required_loan_amount'),
(17, 884042, 2, 2000002, 1, 2, 'Arpita Sinha', 'Arpita Traders', 640463400, 1452369873, 2563149871, 'arpitasinha@st.com', 'Hebbala Bangalore', 'Sanjay Nagar Bangalore', 'Special Referrence By Admin', 6, 'DOB Updated', 1745319471, 'dob'),
(18, 884042, 2, 2000002, 1, 2, 'Arpita Sinha', 'Arpita Traders', 640463400, 1452369873, 2563149871, 'arpitasinha@st.com', 'Hebbala Bangalore', 'Sanjay Nagar Bangalore', 'Special Referrence By Admin', 6, 'Documents Uploaded', 1745323669, ''),
(19, 884042, 2, 2000002, 1, 2, 'Arpita Sinha', 'Arpita Traders', 640463400, 1452369873, 2563149871, 'arpitasinha@st.com', 'Hebbala Bangalore', 'Sanjay Nagar Bangalore', 'Special Referrence By Admin', 6, 'Documents Uploaded', 1745324138, ''),
(20, 884042, 2, 2000002, 1, 2, 'Arpita Sinha', 'Arpita Traders', 640463400, 1452369873, 2563149871, 'arpitasinha@st.com', 'Hebbala Bangalore', 'Sanjay Nagar Bangalore', 'Special Referrence By Admin', 6, 'Documents Uploaded', 1745324252, '');
