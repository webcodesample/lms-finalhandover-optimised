...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 07, 2025 at 06:12 AM
...
INSERT INTO `introducer_list` (`id`, `type`, `name`, `email`, `mobile`, `address`, `commission_percent`, `contact_person`, `document_title`) VALUES
(1, 1, 'Sanjay Kumar', 'sanjay@test.com', 9876501234, 'Sanjay Nagar Bangalore', 30, 'Sanjay Kumar', 'id_proof'),
(2, 2, 'Moti Builders', 'motibuilders@test.com', 1203456798, 'Moti Chamber Hebbala Bangalore', 35, 'Mamta Bafna', 'reg_cert'),
(4, 2, 'Rahul Constructions', 'rahuleconstructions@test.com', 8523614970, 'Hebbala', 30, 'Rahul Sinha', 'reg_cert'),
(5, 2, 'Moti Group', 'sanjaybafna@test.com', 8523614970, 'Hebbala', 40, 'Sanjay Bafna', 'reg_cert');
