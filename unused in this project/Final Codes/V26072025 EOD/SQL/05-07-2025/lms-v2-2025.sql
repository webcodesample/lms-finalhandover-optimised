...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 05, 2025 at 12:32 PM
...
(1001, 'Veeru', 9922001236, 9922001237, 'veeru@cr.com', 631132200, 'No Note', 'Veeru Corporation', 2, 'Hebbal', 1, 20, 0),
(1002, 'arpita', 9945251325, 1234569870, 'arpita@st.com', 0, 'No Note', 'ABC Traders', 1, 'hebbala', 5, 16, 0),
(1004, 'Arpita Sinha', 1452369870, 2563149870, 'arpitasinha@st.com', 0, 'No Note', 'Arpita Traders', 2, 'hebbala', 5, 22, 840000),
...
CREATE TABLE IF NOT EXISTS `lan_ledger_transactions` (
  ...
  `type` int NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=578 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `lrn_activity_history` (
  ...
  `datentime` int NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=185 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `repayment_schedule_list` (
  ...
  `status` int NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=341 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
