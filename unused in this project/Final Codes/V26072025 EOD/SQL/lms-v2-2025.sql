...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 24, 2025 at 12:27 PM
...
(1002, 'arpita', 9945251325, 1234569870, 'arpita@st.com', 0, 'No Note', 'ABC Traders', 1, 'hebbala', 5, 16, 0),
...
(1016, 'Mamta', 9922001346, 0, 'mamta@test.com', 0, 'No Note', '', 1, 'Bangalore', 1, 23, 24000);
...
CREATE TABLE IF NOT EXISTS `lan_ledger_transactions` (
  ...
  `type` int NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=641 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `lrn_audit_history` (
  ...
  `updated_columns` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=197 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(26, 633132, 1, 1016, 1753069796, 'BS2', 1, ''),
...
(396, 6299381753359494, 629938, 1016, 20000, 1000, 0, 21000, 1759343400, 0, 0, 0),
(395, 6299381753359494, 629938, 1016, 0, 1000, 0, 1000, 1758738600, 0, 0, 0),
(394, 6299381753359494, 629938, 1016, 0, 1000, 0, 1000, 1758133800, 0, 0, 0),
(393, 6299381753359494, 629938, 1016, 0, 1000, 0, 1000, 1757529000, 0, 0, 0),
(392, 6299381753359494, 629938, 1016, 0, 1000, 0, 1000, 1756924200, 0, 0, 0),
(391, 6299381753359494, 629938, 1016, 0, 1000, 0, 1000, 1756319400, 0, 0, 0),
(390, 6299381753359494, 629938, 1016, 0, 1000, 0, 1000, 1755714600, 0, 0, 0),
(389, 6299381753359494, 629938, 1016, 0, 1000, 0, 1000, 1755109800, 0, 0, 0),
(388, 6299381753359494, 629938, 1016, 0, 1000, 0, 1000, 1754505000, 0, 0, 0),
(387, 6299381753359494, 629938, 1016, 0, 1000, 0, 1000, 1753900200, 0, 0, 0),
...
CREATE TABLE IF NOT EXISTS `working_on_lrn_list` (
  ...
  `lrn` int NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=270 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
COMMIT;
