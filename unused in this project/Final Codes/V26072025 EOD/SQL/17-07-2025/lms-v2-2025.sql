...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 17, 2025 at 12:32 PM
...
(1004, 'Arpita Sinha', 1452369870, 2563149870, 'arpitasinha@st.com', 0, 'No Note', 'Arpita Traders', 2, 'hebbala', 5, 22, 900000),
...
(2, 'G Yogesh Bafna', 'yogesh@bafna.net', 9902012547, 'Director', 'Management', 1, 1, '1,2,4,5,8,7,25,21,22,23', '1,2,46,45,18,12,16,39,8,9,55,7,47,52,51,50,49,48,53,41,5,42,43,44'),
...
CREATE TABLE IF NOT EXISTS `working_on_lrn_list` (
  ...
  `lrn` int NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=256 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
COMMIT;
