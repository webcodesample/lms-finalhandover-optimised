...
if(isset($_REQUEST['action_perform']))
{
	...
	$clear_filter_btn .= "<a href='temp_leads.php' class='btn btn-sm btn-transparent m-1 p-1' title='Reset Filters'><img src='../portal-icons/reset-filter.png' height='25px'></a>";
