<?php
$logged_user_name = getFieldValue('name','id',$_SESSION['userid'],$_SESSION['user_table'],$con);
?>
...
<nav class="navbar navbar-top fixed-top navbar-expand" id="navbarDefault">
    <div class="collapse navbar-collapse justify-content-between">
        ...
        <a class="navbar-brand me-1 me-sm-3" href="dashboard.php">
            ...
            <div class="d-flex align-items-center"><img src="../images/<?=$site['site_logo']?>" alt="phoenix" height="35"/>
        ...
        <h5 class="text-success"><?=ucwords($logged_user_name)?></h5>
        <h6 class="text-primary"><?=getFieldValue('description','id',$_SESSION['login_type'],'login_type_list',$con)?></h6>
        </div>
        ...
        <li class="nav-item dropdown">
            ...
            <div class="avatar avatar-l ">
                <img class="rounded-circle " src="<?=getProfilePic($_SESSION['user_ref_id'])?>" alt="" />
            </div>
            </a>
            ...
            <div class="card position-relative border-0">
                ...
                <div class="text-center pt-4 pb-3">
                    ...
                    <h6 class="mt-2 text-body-emphasis"><?=ucwords($logged_user_name)?></h6>
                </div>
                </div>
                <div class="overflow-auto scrollbar" style="height: 7rem;">
                <ul class="nav d-flex flex-column mb-1 pb-1">
                    <?php if($_SESSION['login_type'] != 5) {?>
                    <li class="nav-item"><a class="nav-link px-3" href="../myaccount/myaccount.php"> <span class="me-2 text-body" data-feather="user"></span><span>Profile</span></a></li>
                    <li class="nav-item"><a class="nav-link px-3" href="../mydashboard/dashboard.php"><span class="me-2 text-body" data-feather="pie-chart"></span>Dashboard</a></li>
                    <li class="nav-item"><a class="nav-link px-3" href="../myaccount/myaccount.php?tab=settings"> <span class="me-2 text-body" data-feather="settings"></span>Settings &amp; Privacy </a></li>
                    <?php } else {?>
                    <li class="nav-item"><a class="nav-link px-3" href="myaccount.php"> <span class="me-2 text-body" data-feather="user"></span><span>Profile</span></a></li>
                    <li class="nav-item"><a class="nav-link px-3" href="dashboard.php"><span class="me-2 text-body" data-feather="pie-chart"></span>Dashboard</a></li>
                    <li class="nav-item"><a class="nav-link px-3" href="myaccount.php?tab=settings"> <span class="me-2 text-body" data-feather="settings"></span>Settings &amp; Privacy </a></li>
                    <?php } ?>
                </ul>
                </div>
                <div class="px-3"> <a class="btn btn-phoenix-secondary d-flex flex-center w-100" href="../App/logout.php"> <span class="me-2" data-feather="log-out"> </span>Sign out</a></div>
