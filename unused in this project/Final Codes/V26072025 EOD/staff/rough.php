...
$query = "SELECT id FROM submenu_items WHERE parent_menu_item_id = 3";
$authorized_submenu_options_list = mysqli_query($con,$query);
$authorized_submenu_options_array = [];
while($authorized_submenu_options = mysqli_fetch_assoc($authorized_submenu_options_list))
{
    //array_push($authorized_submenu_options_array,$authorized_submenu_options['id']);
    print_r($authorized_submenu_options['id']);
    
}
print_r($authorized_submenu_options_array);
/*
