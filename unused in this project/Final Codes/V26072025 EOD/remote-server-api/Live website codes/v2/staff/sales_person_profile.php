...
<td class="fw-bold text-danger">SP<?=$sales_person['id']?></td>
...
<td>
<input type="email" class="form-control form-control-sm m-1" name="email" id="email" value="<?=$sales_person['email']?>" style="width:250px;" required onBlur="checkEmailUniqueness(this.id,'SP<?=$_REQUEST['sales_person_id']?>')">
</td>
</tr>
...
<td>
<input type="text" class="form-control form-control-sm m-1" name="mobile" id="mobile" value="<?=$sales_person['mobile']?>" style="width:250px;" required onBlur="checkMobileUniqueness(this.id,'SP<?=$_REQUEST['sales_person_id']?>')">
</td>

<td class="align-middle" nowrap>WhatsApp</td>
<td>
<input type="text" class="form-control form-control-sm m-1" name="whatsapp" id="whatsapp" value="<?=$sales_person['whatsapp']?>" style="width:250px;" required onBlur="checkMobileUniqueness(this.id,'SP<?=$_REQUEST['sales_person_id']?>')">
</td>
</tr>
