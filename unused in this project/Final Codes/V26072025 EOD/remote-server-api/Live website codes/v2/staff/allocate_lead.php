...
if(getFieldValue('description','id',$lead_status_id_latest,'lead_status_list',$con) != 'complete')
{
	...
	else
	{
		...
		$lead_activity_data = [
					...
					'comment' => 'assigned to '.$requested_allocation_id,
		...
		$allocated_id_email = getFieldValue('username','ref_id',$requested_allocation_id,'login_detail',$con);
		urnupdationEmailHistory('URN Allocation',$_REQUEST['lead_id'],$allocated_id_email,$con);
