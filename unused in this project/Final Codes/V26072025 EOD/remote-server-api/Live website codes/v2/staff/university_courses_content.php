...
<h5 class="mt-2"><?=getFieldValue("name","id",$_REQUEST['university_id'],"university_list",$con)?> Course List</h5>
<?php setGoBack("university_list.php"); ?>
</div>

<form id="search_form" method="post">
<div class="d-flex mt-2">
<input type="text" class="form-control form-control-sm m-1" style="width:150px;" name="keyword" id="keyword" onChange="liveSearch()" value="<?php if(isset($_REQUEST['keyword']) && $_REQUEST['keyword']) echo $_REQUEST['keyword'];?>" placeholder="Keyword">
...
<a href="university_courses.php?university_id=<?=$_REQUEST['university_id']?>"><img src="../portal-icons/reset.png"></a>
</div>
