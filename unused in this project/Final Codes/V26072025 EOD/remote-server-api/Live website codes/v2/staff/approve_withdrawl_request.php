...
//create Withdrawal Approval Email History
withdrawalEmailHistory('Withdrawal Approval',$_REQUEST['wallet_id'],$con);
...
else if(isset($_REQUEST['sales_person_id']) && $_REQUEST['sales_person_id'] != '')
header("Location:manage_sales_person.php?sales_person_id=".$_REQUEST['sales_person_id']."&tab=withdrawl_request");
?>