...
if(isset($_REQUEST['tab']) && $_REQUEST['tab'] == 'past')
{
	...
	$callback_list = getRowsDataConAdvance('callback_list',$where_con_array_past,$con);
}
else if(isset($_REQUEST['tab']) && $_REQUEST['tab'] == 'today')
{
	$today_callback = "active";
	$callback_list = getRowsDataConAdvance('callback_list',$where_con_array_today,$con);
}
else if(isset($_REQUEST['tab']) && $_REQUEST['tab'] == 'future')
{
	$future_callback = "active";
	$callback_list = getRowsDataConAdvance('callback_list',$where_con_array_future,$con);
}
else 
{
	$all_callback = "active";
