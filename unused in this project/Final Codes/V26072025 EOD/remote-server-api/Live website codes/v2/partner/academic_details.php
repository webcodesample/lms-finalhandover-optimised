...
<div class="d-flex">
<select name="highest_education_from_year" class="form-select form-select-sm m-1" style="width:200px;" required>
...
<select name="highest_education_to_year" class="form-select form-select-sm m-1" style="width:200px;" required>
<option value="">To Year</option>
<?=generateYearDropdown(1990,$student['highest_education_to_year'])?>
</select>
...
<textarea class="form-control form-control-sm m-1 mt-3" name="updation_remark" placeholder="Academic Details Updation Remark" required style="width:410px;height:100px;"></textarea>

<div class="text-center mt-3" style="width:400px;">
<button type="submit" class="btn btn-sm btn-primary m-1 <?=$urn_visibility_class?>" <?=$field_visibility?>>Update Academic Details</button>
</div>
</form>
