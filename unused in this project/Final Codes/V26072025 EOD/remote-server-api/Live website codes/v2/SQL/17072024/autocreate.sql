...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 17, 2024 at 12:12 PM
...
INSERT INTO `temp_leads` (`id`, `name`, `mobile`, `email`, `datentime`, `creator_id`, `creator_type`, `source_id`) VALUES
(2, 'Rahul', 12345, 'rahul@test', 1720429137, 2, 1, 1),
(3, 'Rajiv', 12345, '', 1720429137, 2, 1, 1),
(4, 'Rakesh', 12345, '', 1720429137, 2, 1, 2),
(5, 'Rajesh', 12345, 'rajesh@test', 1720429137, 2, 1, 3),
(6, 'Jasi', 12345, 'jasi@test', 1720429137, 2, 1, 3),
(7, 'Rita', 12345, 'rita@test', 1720429137, 2, 1, 3),
(8, 'Yogesh', 12345, 'yogesh@test', 1720429137, 2, 1, 2),
(9, 'Mamta', 12345, 'mamta@test', 1720429137, 2, 1, 1),
(10, 'Thomas', 12345, 'thomas@test', 1720429137, 2, 1, 4),
(11, 'Shubh', 12345, 'shubh@test', 1720429137, 2, 1, 4),
(12, 'Suhana', 12345, 'suhana@test', 1720429137, 2, 1, 1),
(13, 'Sonakshi', 12345, 'sonakshi@test', 1720429137, 2, 1, 2),
(14, 'Ranveer', 12345, 'ranveer@test', 1720429137, 2, 1, 2),
(15, 'Sudha', 12345, 'sudha@test', 1720429137, 2, 1, 2),
(16, 'Smita', 12345, 'smita@test', 1720429137, 2, 1, 1),
(17, 'James', 12345, 'james@test', 1720429137, 2, 1, 3),
(18, 'Poonam', 12345, 'poonam@test', 1720429137, 2, 1, 3),
(19, 'Savita', 12345, 'savita@test', 1720429137, 2, 1, 2),
(20, 'Mahesh', 12345, 'mahesh@test', 1720429137, 2, 1, 1),
(21, 'Ahmad', 12345, 'ahmad@test', 1720429137, 2, 1, 2),
(22, 'Taiyab', 12345, 'taiyab@test', 1720429137, 2, 1, 2),
(23, 'Imran', 12345, 'imran@test', 1720429137, 2, 1, 2),
(24, 'Jasmin', 12345, 'jasmin@test', 1720429137, 2, 1, 1),
(25, 'Golu', 12345, '', 1720429137, 2, 1, 1),
(26, 'Ritika', 12345, '', 1720429137, 2, 1, 1),
(27, 'Manish', 12345, '', 1720429137, 2, 1, 1),
(28, 'Navin', 12345, '', 1720429137, 2, 1, 1),
(29, 'Uday', 12345, 'uday@test', 1720429137, 2, 1, 2);
