...
$user = mysqli_fetch_assoc(getRowsDataCon('staff_list',$where_con_array,$con));
...
<div class="row mb-3">
    ...
    <div class="col-sm-10">
        <img class="rounded-circle border border-primary" src="<?=getProfilePic($_SESSION['staff_ref_id'])?>" height="70px" width="70px">
    </div>
</div>
