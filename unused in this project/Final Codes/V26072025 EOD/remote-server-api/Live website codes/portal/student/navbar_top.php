            ...
            <li class="nav-item dropdown">
              <a class="nav-link lh-1 pe-0" id="navbarDropdownUser" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">
                <div class="avatar avatar-l ">
                  <img class="rounded-circle border border-primary" src="<?=getProfilePic($_SESSION['student_ref_id'])?>" alt="" />
                </div>
              </a>
                ...
                <div class="card position-relative border-0">
                  ...
                  <div class="overflow-auto scrollbar" style="height: 7rem;">
                    <ul class="nav d-flex flex-column mb-1 pb-1">
                      <li class="nav-item"><a class="nav-link px-3" href="myprofile.php"> <span class="me-2 text-body" data-feather="user"></span><span>Profile</span></a></li>
                      ...
                      <li class="nav-item"><a class="nav-link px-3" href="mysettings.php"> <span class="me-2 text-body" data-feather="settings"></span>Settings &amp; Privacy </a></li>
                    </ul>
                  </div>
