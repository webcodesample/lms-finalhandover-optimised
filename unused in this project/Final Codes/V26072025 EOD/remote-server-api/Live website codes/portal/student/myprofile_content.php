...
<div class="row mb-3">
    ...
    <div class="col-sm-10">
        <img class="rounded-circle border border-primary" src="<?=getProfilePic($_SESSION['student_ref_id'])?>" height="70px" width="70px">
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-sm-10">
      <input type="text" name="alternate_mobile" class="form-control form-control-sm m-1" value="<?=$user['alternate_mobile']?>" style="width:200px;" required minlength="10">
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-sm-10">
      <input type="date" name="dob" class="form-control form-control-sm m-1" value="<?= date('Y-m-d', $user['dob'])?>" style="width:200px;" required minlength="10">
    </div>
</div>
