...
$lead_data_array = [
			...
			'created_by' => $_SESSION['agent_ref_id'],
			'source_id' => $_REQUEST['lead_source_id'],
			'allocated_id' => $_SESSION['agent_ref_id'],
		];
	
$inserted_lead_id = insertData('leads_details', $lead_data_array, $con);

//step 3 : craete new lead allocation record
$lead_allocation_data = [
						'lead_id' => $inserted_lead_id,
						'allocated_id' => $_SESSION['agent_ref_id'],
						'datentime' => strtotime('now'),
						];
insertData('lead_allocation_list',$lead_allocation_data,$con);

//step 4 : insert new lead activity record
$activty_info_array = [
					'lead_id' => $inserted_lead_id,
					'status_id' => $new_lead_status_id,
					'comment' => 'URN Created',
...
//step 5 : insert urn_audit_history
$urn_audit_history_array = [
					...
					'updation_remark' => 'Created By Backend',
					'datentime' => strtotime('now'),
					];
	
insertData('urn_audit_history', $urn_audit_history_array, $con);

//Step 6 : delete requested temp lead from temp_leads
