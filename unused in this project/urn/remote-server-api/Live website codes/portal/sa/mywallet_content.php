...
<div>
<span class="text-success m-1 fw-bold">Withdrable : <?=$withdrwable_balance?></span>
<?php
if($wallet_current_balance)
{
?>
<input type="button" class="btn btn-sm btn-warning m-1 px-1 py-1" data-bs-toggle="modal" data-bs-target="#withdrawlRequest" value="Request Withdrawl">
<?php
}
?>
</div>
