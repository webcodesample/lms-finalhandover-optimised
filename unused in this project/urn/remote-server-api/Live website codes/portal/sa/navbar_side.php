          ...
          <div class="navbar-vertical-content">
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
              ...
              <li class="nav-item">
                ...
                <!-- parent pages-->
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-MYACCOUNT" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-MYACCOUNT">
                    <div class="d-flex align-items-center">
                      <div class="dropdown-indicator-icon-wrapper"><span class="fas fa-caret-right dropdown-indicator-icon"></span></div><span class="nav-link-icon"><span data-feather="user"></span></span><span class="nav-link-text">Account</span>
                    </div>
                  </a>
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-MYACCOUNT">
                      <li class="nav-item"><a class="nav-link" href="myaccount.php">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Profile</span>
                          </div>
                        </a>
                        <!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="mywallet.php">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Wallet</span>
                          </div>
                        </a>
                        <!-- more inner pages-->
                      </li>
