...
<input type="hidden" name="lead_id" value="<?=$_REQUEST['lead_id']?>">
  <?php
    ...
    echo "<tr>
        ...
        <button type='submit' class='btn btn-primary btn-sm m-1' ".$field_visibility.">Upload Documents</button>
    ...
    if($total_documents)
    {
        ...
        while($uploaded_document = mysqli_fetch_assoc($result_get_uploaded_document_list))
        {
            ...
            else if(substr($uploaded_document['upload_by'],0,2) == 'SA')
            {
                ...
                $uploader_type_id = getFieldValue('role_type','id',substr($uploaded_document['upload_by'],2),'agent_list',$con);
            }
            else if(substr($uploaded_document['upload_by'],0,2) == 'SP')
            {
                ...
                $uploader_type_id = getFieldValue('role_type','id',substr($uploaded_document['upload_by'],2),'sales_person_list',$con);
            }
