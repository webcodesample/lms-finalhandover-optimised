...
$wallet_balance = getFieldValue('balance','id',$wallet_id,'wallet_list',$con);
 ...
 while($wallet_transaction = mysqli_fetch_assoc($wallet_transactions))
 {
	 ...
	 if($wallet_transaction['transaction_type'] == 111)
		...
		$remark_suffix = " <a href='transaction_detail.php?transaction_id=".$wallet_transaction['transaction_id']."&agent_id=".$_REQUEST['agent_id']."' class='link-success text-decoration-none'>".$wallet_transaction['transaction_id']."</a>";
