...
$current_status_step_order = getFieldValue('step_order','id',$current_status_id,'lead_status_list',$con);
$current_status_description = getFieldValue('description','id',$current_status_id,'lead_status_list',$con);
...
if($current_status_step_order < 4)
	echo "<a href='urn_course_selection.php?lead_id=".$_REQUEST['lead_id']."&course_id=".$lead['course_id']."'>
  <img src='../portal-icons/edit_black.png' height='20px'>
  </a>";
?>
</td>  
