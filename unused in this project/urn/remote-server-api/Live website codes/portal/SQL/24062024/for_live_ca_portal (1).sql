...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 24, 2024 at 12:20 PM
...
INSERT INTO `leads_details` (`id`, `urn`, `status_id`, `status_batch_id`, `student_id`, `course_id`, `datentime`, `source`) VALUES
(1, 894083, 11, 1, 1, 1, 1719211799, 'admin portal'),
(2, 239941, 1, 1, 1, 2, 1719213342, 'Student Dashboard');
...
(33, 'BS2', 'jasintha@moticorporation.com', '123456', 3, 1),
(32, 'BS1', 'yogesh@bafna.net', '12345', 1, 1),
...
(1, 'Yogesh Bafna', 'yogesh@bafna.net', 9902012547, 'Director', 'Management', 1),
(2, 'Jasintha', 'jasintha@moticorporation.com', 1234567890, 'CSE', 'Support', 3);
