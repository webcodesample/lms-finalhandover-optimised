<h6 class="text-danger">Note : These are manadatory documents for verification purpose.</h6>
...
<input type="hidden" name="lead_id" value="<?=$_REQUEST['lead_id']?>">
  <?php
    ...
    echo "<tr>
        ...
        <button type='submit' class='btn btn-primary btn-sm m-1 ".$urn_visibility_class."' ".$field_visibility." onClick='return makeConfirm(&quot;upload&quot;)'>Upload Documents</button>
    ...
    if($total_documents)
    {
        ...
        while($uploaded_document = mysqli_fetch_assoc($result_get_uploaded_document_list))
        {
            ...
            echo "<tr>
                ...
                <a href='#' class='".$urn_visibility_class."' data-bs-toggle='modal' data-bs-target='#deleteURNDocument' onClick='addDataToURNDocumentDeletionModal(".$uploaded_document['id'].")' ".$field_visibility."><img src='../portal-icons/delete.png' height='20px' width='20px'></a>
                </td>
                </tr>";
        }
        echo "</tbody></table>";
...
<?php include_once("../modal_boxes/urn_document_deletion_modal.php"); ?>
