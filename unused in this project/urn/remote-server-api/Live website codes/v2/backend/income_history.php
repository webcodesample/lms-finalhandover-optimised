...
while($income = mysqli_fetch_assoc($income_list))
{
	...
	{
		echo "<td nowrap>
			<a class='btn btn-sm p-0 bg-light' onClick='showIframe(&quot;income_proof.php?lead_id=".$income['lead_id']."&quot;)' data-bs-toggle='modal' data-bs-target='#transactionProof'>
...
<?php include_once("transaction_proof_modal.php") ?>