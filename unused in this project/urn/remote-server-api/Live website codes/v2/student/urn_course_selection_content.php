...
<input type="button" value="Select" class="btn btn-sm btn-subtle-success m-1" onClick="updateURNCourse()">
<a class="btn btn-sm btn-subtle-danger m-1" href="urn_details.php?lead_id=<?=$_REQUEST['lead_id']?>&tab=profile">Back</a>
</div>
<input type="hidden" name="action_perform" value="search_filter">
<input type="hidden" name="page_index" id="page_index">
</form>

<form id="urn_course_selection_form" action="update_urn_course_selection.php" method="post">
