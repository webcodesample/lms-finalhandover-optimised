...
if($modification_possible_flag == 1)
{ ?>
    <tr class="mb-2">
    <td colspan="6" align="right">
    <?php if($lead_allocation_count) {?>
    <input type="button" class="btn btn-subtle-warning btn-sm" data-bs-toggle="modal" data-bs-target="#manageLead" value="Reallocate">
    <?php }
    else { ?>
    <input type="button" class="btn btn-subtle-warning btn-sm" data-bs-toggle="modal" data-bs-target="#manageLead" value="Allocate">
    <?php } ?>
    <input type="button" class="btn btn-subtle-success btn-sm" data-bs-toggle="modal" data-bs-target="#urnLeadCommunication" value="Communication">
    <?php if($current_status_description != 'Deleted' && $current_status_description != 'Pending' && $current_status_description != 'Complete')
    {
    ?>
    <input type="button" class="btn btn-subtle-danger btn-sm" data-bs-toggle="modal" data-bs-target="#killLead" value="Delete Lead">
    <?php } ?>
    <?php if($current_status_description == 'Pending')
    {
    ?>
    <input type="button" class="btn btn-subtle-danger btn-sm" data-bs-toggle="modal" data-bs-target="#approveDeletion" value="Approve Deletion">
    <?php } ?>
    <?php if($current_status_description == 'Applied') {?>
    <input type="button" class="btn btn-subtle-danger btn-sm" data-bs-toggle="modal" data-bs-target="#urnRejected" value="URN Rejected">
    <?php } ?>
    <?php if($current_status_description == 'Visa Applied') {?>
    <input type="button" class="btn btn-subtle-danger btn-sm" data-bs-toggle="modal" data-bs-target="#visaRejected" value="VISA Rejected">
    <?php } ?>
    <br><br>
    </td>
    </tr>
...
include_once("urn_communication_modal.php");
?>
