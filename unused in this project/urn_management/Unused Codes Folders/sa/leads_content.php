    <div class="pb-6 mt-1">
        ...
        <div class="row g-3 justify-content-between mb-4">
            ...
            <div class="d-md-flex justify-content-between">
                ...
                <h4 class="mt-2">Total <?=$total_leads?> URN</h4>
            </div>
            </div>
            <div class="col-auto">
            <div class="d-flex">
            ...
            ?>
                ...
                <td class="name align-middle white-space-nowrap ps-0">
                    <div class="d-flex align-items-center"><a href="#!">
                        <div class="avatar avatar-xl me-3"><img class="rounded-circle" src="<?=getLatestURNProfilePic($leads['lead_id'],$leads['urn'],$con)?>" alt="" />
                        </div>
                    </a>
                ...
                <td class="date align-middle white-space-nowrap text-body-tertiary text-opacity-85 ps-4 text-body-tertiary"><?=date('d-m-Y H:i:s A',$leads['lead_created_on'])?></td>
