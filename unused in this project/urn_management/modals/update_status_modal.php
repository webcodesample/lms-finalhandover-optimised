        ...
        <table class="table table-sm table-borderless w-auto">
            ...
            <tr>
                <td align="center">
                    ...
                    <?php
                    if($current_status_step_order == 3 && $mandatory_documents_upload_status == 0)
                    {
                        echo "<input type='submit' class='btn btn-primary rounded' value='Update Status' disabled>";
                    }
                    else
                    {
                        echo "<input type='submit' class='btn btn-primary rounded' value='Update Status'>";
                    }
                    ?>
