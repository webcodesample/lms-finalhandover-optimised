...
Dear <span class="text-danger"><?=$_REQUEST['full_name']?></span>, your details has been submitted.<br> Login activation link has mailed to <span class="text-danger"><?=$_REQUEST['email']?></span>
</h6>
</center>
<form action="upload_documents.php" method="post" enctype="multipart/form-data">
<div class="container mt-2">
<h6 class="text-primary">Step 2<span class="text-danger"> (This step is optional,click on 'Skip & Submit' Button to skip)</span></h6>
</div>
