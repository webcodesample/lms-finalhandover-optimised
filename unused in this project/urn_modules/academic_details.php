...
<textarea class="form-control form-control-sm m-1 mt-3 <?=setBtnVisibilityClass($urn_using_by_me)?>" name="updation_remark" placeholder="Academic Details Updation Remark" required style="width:410px;height:100px;"></textarea>

<div class="text-center mt-3" style="width:400px;">
<button type="submit" class="btn btn-sm btn-primary m-1 <?=setBtnVisibilityClass($urn_using_by_me)?>" <?=$field_visibility?>>Update Academic Details</button>
</div>
<?php } ?>
</form>
