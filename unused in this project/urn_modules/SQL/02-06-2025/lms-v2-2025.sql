...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 02, 2025 at 12:32 PM
...
(1, 858612, 858612, 200000, 10000, 1748693379, 1748629800, 1);
...
INSERT INTO `lan_audit_history` (`id`, `lan`, `lrn`, `product_id`, `required_loan_amount`, `status_id`, `cust_type`, `name`, `company_name`, `company_type`, `company_doi`, `company_turnover`, `company_email`, `company_mobile`, `company_address`, `dob`, `mobile`, `alt_mobile`, `email`, `permanent_address`, `current_address`, `brief_note`, `guarantor_id`, `introducer_id`, `bank_account`, `approved_loan_amount`, `payment_frequency`, `loan_tenure`, `roi`, `updation_remark`, `datentime`, `updated_columns`, `approval_date`, `dispatch_date`) VALUES
(3, 858612, 858612, 2, 200000, 4, 2, 'Arpita Sinha', 'Arpita Traders', 4, 1743445800, 1000000, 'mgbafna1957@gmail.com', 1234567890, 'Moti Chamber Hebbal 560024 India', 631132200, 1452369870, 2563149870, 'arpitasinha@st.com', 'Hebbala', '#1 4th A Main road Vinayakanagar Bangalore 560024 India', 'No Note', 6, 1, 22, 10000, 'Weekly', 10, 5, 'LAN Dispatched', 1748693379, 'approval_date,dispatch_date', 1748629800, 1748867321);
...
(166, 858612, 4, 'Approved & waiting for dispatch', 'BS2', 1748693379),
...
(156, 858612, 2, 200000, 4, 2, 'Arpita Sinha', 'Arpita Traders', 4, 1743445800, 1000000, 'mgbafna1957@gmail.com', 1234567890, 'Moti Chamber Hebbal 560024 India', 631132200, 1452369870, 2563149870, 'arpitasinha@st.com', 'Hebbala', '#1 4th A Main road Vinayakanagar Bangalore 560024 India', 'No Note', 6, 1, 22, 10000, 'Weekly', 10, 5, 'Approved & waiting for dispatch', 1748693379, 'status_id'),
