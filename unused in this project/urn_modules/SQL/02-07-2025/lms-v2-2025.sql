...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 02, 2025 at 12:32 PM
...
(1001, 'Veeru', 9922001236, 9922001237, 'veeru@cr.com', 631132200, 'No Note', 'Veeru Corporation', 2, 'Hebbal', 1, 20),
...
(3, 2, 1751455651, 0, 0, 4574861750762985, '', '');
...
(74, 4574861750762985, 457486, 2, 1000000, 4, 2, 'Veeru Yadav', 'Veeru Corporation', 5, 1735669800, 500000, 'abctraders@test.com', 9876501235, 'Yeshwantpur North Bangalore India 560021', 631132200, 9922001236, 9922001236, 'veeru@st.com', 'Hebbal1', 'Hebbal', 'No Note', 8, 5, 20, 500000, 'Monthly', 10, 4, 'LAN Dispatched & Amount Disbursed', 1751258074, ''),
(75, 4574861750762985, 457486, 2, 1000000, 4, 2, 'Veeru Yadav', 'Veeru Corporation', 5, 1735669800, 500000, 'abctraders@test.com', 9876501235, 'Yeshwantpur North Bangalore India 560021', 631132200, 9922001236, 9922001236, 'veeru@st.com', 'Hebbal1', 'Hebbal', 'No Note', 8, 5, 20, 550000, 'Monthly', 10, 4, 'Topup Amount Approved', 1751259442, 'approved_loan_amount');
...
CREATE TABLE IF NOT EXISTS `repayment_schedule_list` (
  ...
  `status` int NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=329 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(2, 'G Yogesh Bafna', 'yogesh@bafna.net', 9902012547, 'Director', 'Management', 1, 1, '1,2,4,5,7,25,21,22,23', '1,2,46,45,18,12,16,39,7,47,52,51,50,49,48,53,41,5,42,43,44'),
...
(36, 'LAN', 'mylan_list.php', 17),
(37, 'Application', 'mylrn_list.php', 17),
...
--
-- Dumping data for table `working_on_lan_list`
--

INSERT INTO `working_on_lan_list` (`id`, `user`, `lan`) VALUES
(12, 'CR1001', 4574861750762985);
