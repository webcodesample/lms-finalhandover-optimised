...
<div>
<a href="add_university.php"><img src="../portal-icons/add.png" width="25px"></a>
<button class="btn btn-sm btn-subtle-success m-1 p-1" data-bs-toggle="modal" data-bs-target="#importUniversity">Import</button>
<a href="../sample_format/university_sheet_format.xlsx" class="btn btn-sm btn-subtle-warning m-1 p-1">Sample Sheet</a>
</div>
</div>
<center>
