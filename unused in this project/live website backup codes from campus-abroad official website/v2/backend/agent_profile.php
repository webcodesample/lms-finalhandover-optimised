...
<td class="fw-bold text-danger">SA<?=(100+$agent['id'])?></td>
...
<td>
<input type="email" class="form-control form-control-sm m-1" name="email" value="<?=$agent['email']?>" style="width:250px;" <?=$company_input_required?>>
</td>
</tr>
...
<td>
<input type="text" class="form-control form-control-sm m-1" name="mobile" value="<?=$agent['mobile']?>" style="width:250px;" <?=$company_input_required?>>
</td>

<td class="align-middle" nowrap>WhatsApp</td>
<td>
<input type="text" class="form-control form-control-sm m-1" name="whatsapp" value="<?=$agent['whatsapp']?>" style="width:250px;" required>
</td>
</tr>
...
<td class="align-middle" nowrap>Name</td>
<td>
<input type="text" class="form-control form-control-sm m-1" name="company_name" id="company_name" value="<?=$agent['company_name']?>" style="width:250px;" required>
</td>

<td class="align-middle" nowrap>Website</td>
<td>
<input type="text" class="form-control form-control-sm m-1" name="company_website" id="company_website" value="<?=$agent['company_website']?>" style="width:250px;" required>
</td>
</tr>
...
<td>
<input type="text" class="form-control form-control-sm m-1" name="company_address" id="company_address" value="<?=$agent['company_address']?>" style="width:250px;" required>
</td>
</tr>
