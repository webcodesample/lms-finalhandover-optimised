...
$next_status_description = $_REQUEST['next_status_description'];
...
//insert deletion_pending_leads for management/admin approval
$where_con_array_pending = ['lead_id' => $_REQUEST['lead_id'],];

$deletion_pending_lead_data = [
								'approved_by' => $_SESSION['userid'],
								'approval_datentime' => strtotime('now'),
								'approval_remark' => $_REQUEST['updation_remark']
								];

updateData('deletion_pending_leads', $deletion_pending_lead_data,$where_con_array_pending,$con);
