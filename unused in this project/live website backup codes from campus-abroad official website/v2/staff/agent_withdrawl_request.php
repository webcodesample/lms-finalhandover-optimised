...
<h5 class="mt-2 text-nowrap">Pending Withdrawal Request</h5>
<div class="d-flex">
...
<button type="submit" onClick="return validateWRSelection()" class="btn btn-sm btn-subtle-danger m-1 text-nowrap">Approve Withdrawal</button>
</div>
</div>
