...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 11, 2024 at 11:54 AM
...
(1, 0, 'Yogesh Bafna', 'yogesh@test.com', 9902015247, 9902015247, '', '', '', 30, 1),
(2, 1, 'Y Mamta Bafna', 'mamta@test.com', 1234567890, 1234567890, 'Moti Corporation', 'Hebbal Bangalore', 'www.moticorporation.com', 35, 1);
...
CREATE TABLE IF NOT EXISTS `chat_history` (
  ...
  `receiver_id` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
(1, 'Rakesh', 'rakesh@gmail.com', 1234567890, 1234567890, 10000, 30, 1);
...
(2, 'Yogesh Bafna', 'yogesh@test.com', 1234567890, 'Director', 'Management', 1),
...
(8, 'Manish Bafna', 'manish@bafna.net', 123456, 'Manager', 'Management', 8);
...
(34, 'Rahul', 12345, '', 1720068984, 2, 4, 1),
(3, 'Rajiv', 12345, '', 1719830721, 3, 3, 1),
(4, 'Rakesh', 12345, '', 1719830721, 3, 3, 2),
(32, 'test std', 1234567893, 'ssstd@test', 1720068688, 2, 4, 2),
(30, 'test std', 1234567891, 'std@test', 1720068211, 2, 1, 5),
(9, 'Mamta', 12345, 'mamta@test', 1719830721, 3, 3, 1),
(10, 'Thomas', 12345, 'thomas@test', 1719830721, 3, 3, 4),
(11, 'Shubh', 12345, 'shubh@test', 1719830721, 3, 3, 4),
(12, 'Suhana', 12345, 'suhana@test', 1719830721, 3, 3, 1),
(13, 'Sonakshi', 12345, 'sonakshi@test', 1719830721, 3, 3, 2),
(14, 'Ranveer', 12345, 'ranveer@test', 1719830721, 3, 3, 2),
(15, 'Sudha', 12345, 'sudha@test', 1719830721, 3, 3, 2),
(16, 'Smita', 12345, 'smita@test', 1719830721, 3, 3, 1),
(17, 'James', 12345, 'james@test', 1719830721, 3, 3, 3),
(18, 'Poonam', 12345, 'poonam@test', 1719830721, 3, 3, 3),
(19, 'Savita', 12345, 'savita@test', 1719830721, 3, 3, 2),
(20, 'Mahesh', 12345, 'mahesh@test', 1719830721, 3, 3, 1),
(21, 'Ahmad', 12345, 'ahmad@test', 1719830721, 3, 3, 2),
(22, 'Taiyab', 12345, 'taiyab@test', 1719830721, 3, 3, 2),
(23, 'Imran', 12345, 'imran@test', 1719830721, 3, 3, 2),
(24, 'Jasmin', 12345, 'jasmin@test', 1719830721, 3, 3, 1),
(25, 'Golu', 12345, '', 1719830721, 3, 3, 1),
(26, 'Ritika', 12345, '', 1719830721, 3, 3, 1),
(27, 'Manish', 12345, '', 1719830721, 3, 3, 1),
(28, 'Navin', 12345, '', 1719830721, 3, 3, 1),
(29, 'Uday', 12345, 'uday@test', 1719830721, 3, 3, 2);
...
(1, 1, 'Wallet Created', 0, '', 1719905137, 111),
(2, 2, 'Wallet Created', 0, '', 1719905198, 111),
(3, 3, 'Wallet Created', 0, '', 1719913377, 111);
