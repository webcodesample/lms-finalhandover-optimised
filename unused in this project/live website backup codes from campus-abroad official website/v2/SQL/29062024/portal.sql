...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 29, 2024 at 12:15 PM
...
CREATE TABLE IF NOT EXISTS `deletion_pending_leads` (
  ...
  `req_remark` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `approval_remark` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `lead_allocation_list` (
  `id` int NOT NULL AUTO_INCREMENT,
  `lead_id` int NOT NULL,
  `allocated_id` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `datentime` int NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(8, 'Manish', 'manish@bafna.net', 123456, 'Manager', 'Management', 8);
...
(1, 1, 401241, '10th_makrkssheet_1719646556.jpg', 1719646556, 'BS3'),
(2, 1, 401241, '5_1719646556.pdf', 1719646556, '0'),
(3, 1, 401241, '10th_certificate_1719647082.jpg', 1719647082, 'ST1'),
(4, 1, 401241, 'ielts_score_card_1719651962.jpg', 1719651962, 'ST1'),
(5, 2, 839613, '10th_makrkssheet_1719661191.jpg', 1719661191, 'BS3'),
(6, 2, 839613, '5_1719661191.pdf', 1719661191, '0'),
(7, 2, 839613, '12th_certificate_1719661412.jpg', 1719661412, 'ST2'),
(8, 2, 839613, '12th_markssheet_1719661742.jpg', 1719661742, 'ST2');
