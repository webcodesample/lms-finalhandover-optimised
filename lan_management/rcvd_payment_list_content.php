...
while($rcvd_payment = mysqli_fetch_assoc($rcvd_payment_list))
{
	...
	echo "<tr>
		...
		<td class='text-end px-1'>".$rcvd_payment['total_due']."</td>
		<td class='text-end px-1'>".$rcvd_payment['total_collection']."</td>
		<td class='text-end px-1'>".$balance_due."</td>
		<td class='text-center px-1'><a href='datewise_rcvd_payment_list.php?date=".$date."'>View List</a></td>	
		</tr>";
}
