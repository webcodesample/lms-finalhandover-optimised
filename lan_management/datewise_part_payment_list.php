...
$where_con = "WHERE status = 2 AND collected_date = ".$payment_date;

$rcvd_payment_list = mysqli_query($con, "SELECT * FROM repayment_schedule_list ".$where_con." ORDER BY collected_date DESC");
