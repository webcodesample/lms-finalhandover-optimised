...
$current_week_lead_count = getRowCountMultiCol(setWhereClauseAdvance($where_con_array_this_week),'lrn_list',$con);

$where_con_array_last_week = [ ("datentime >". $last_week_start),("datentime <". $last_week_end)];
$last_week_lead_count = getRowCountMultiCol(setWhereClauseAdvance($where_con_array_last_week),'lrn_list',$con);
?>
...
<div class="card h-100">
    ...
    <div class="d-flex d-sm-block justify-content-between">
        ...
        <div class="d-flex align-items-center">
            ...
            <p class="text-body-tertiary fs-9 mb-0 ms-2 mt-3">New LRNs</p>
        </div>
        <p class="text-info mt-2 fs-6 fw-bold mb-0 mb-sm-4">
        <a href="../lrn_management/lrns_current_week.php" class="text-decoration-none"><?=$current_week_lead_count?></a>
