...
$deletion_pending_lead_data = [
								'lead_id' => $_REQUEST['lead_id'],
								'status_before_req' => $_REQUEST['current_status_id'],
								'batch_id' => $_REQUEST['current_status_batch_id'],
								'req_by' => $_SESSION['userid'],
								'req_remark' => $_REQUEST['updation_remark'],
								'req_datentime' => strtotime('now'),
								];

insertData('deletion_pending_leads', $deletion_pending_lead_data,$con);
