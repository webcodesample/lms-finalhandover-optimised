...
<center><h5 class="mb-5 bg-danger-subtle py-2">Loan Application Form</h5></center>
<?php
...
include_once("../lrn_print_modules/lrn_print_lrn_section.php");
include_once("../lrn_print_modules/lrn_print_profile_section.php");

if($lrn['cust_type'] == 2)
include_once("../lrn_print_modules/lrn_print_company_section.php");

include_once("../lrn_print_modules/lrn_print_loan_section.php");
include_once("../lrn_print_modules/lrn_print_bank_section.php");

if($lrn['guarantor_id'] > 0)
include_once("../lrn_print_modules/lrn_print_guarantor_section.php");

include_once("../lrn_print_modules/lrn_print_document_section.php");
?>
</div>
