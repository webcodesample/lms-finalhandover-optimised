...
<input type="text" name="wsp_name" id="wsp_name" value="<?=$site['wsp_name']?>" <?=$input_design?> disabled>
</div>

<div class="d-flex">
<div class="pt-2" style="width:100px;">WSP URL</div>
<input type="text" name="wsp_url" id="wsp_url" value="<?=$site['wsp_url']?>" <?=$input_design?> disabled>
</div>

<div class="d-flex">
<div class="pt-2" style="width:100px;">CRM Version</div>
<input type="text" name="crm_version" id="crm_version" value="<?=$site['crm_version']?>" <?=$input_design?> disabled>
</div>
