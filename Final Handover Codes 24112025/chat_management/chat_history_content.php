...
if(isset($_REQUEST['chat_with']) && $_REQUEST['chat_with'])
{
    ...
    else if(substr($_REQUEST['chat_with'],0,2) == 'CR')
    {
        $chat_with_name = getFieldValue('name','id',substr($_REQUEST['chat_with'],2),'customers_list',$con);
        $chatEndBtn = "<a class='btn btn-sm btn-outline-danger p-1' href='endChat.php?cust_id=".$_REQUEST['chat_with']."' title='Leave OR End Chat'>End/Leave</a>";
    }
