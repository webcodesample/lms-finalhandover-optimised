...
if($lrn_using_by_me && !in_array($current_status_description,$finalise_status_array))
{
	$pen_tool_display = "";
...
<?php
include_once("lrn_call_list.php");
include_once("lrn_emails.php");
include_once("lrn_callback_list.php");
include_once("../modal_boxes/communication/lrn_call_history_modal.php");
?>