...
//step 1 A :create student login details & insert data in login_detail table

$student_login_detail_data = [
...
insertData('login_detail', $student_login_detail_data,$con);
...
header("Location:../urn_management/urn_history.php?lead_id=".$inserted_lead_id."&tab=documents");
